    ...
    {{ Breadcrumbs::render('servicios') }}
        <div class="row">
            ...
            <div class="col s12">
                ...
                <!-- Plantilla para mostrar el servicio -->
                <div class=" row z-depth-2 section ">
                    ...
                    <div class="col s12 m7 l8" style="padding-right: 30px;">
                        <p>
                        ...
                        <p>
                            En Prophysio tenemos dos objetivos principales: brindar rehabilitación deportiva a los pacientes que hayan sufrido algún percance y trabajar en la prevención de lesiones físicas.
                        </p>
                    </div>
                </div>
                ...
                <div class="row z-depth-2 section">
                    <center><h5> Fisioterapia Traumatológica y Ortopédica</h5></center>
                    <div class=" col s12 m7 l8" style="padding-left: 30px;">                        
                        <p>
                            La fisioterapia traumatológica y ortopédica es un área especializada encargada de diagnosticar, evaluar y tratar lesiones de carácter músculo-esqueléticas. Este tipo de lesiones ocurren en tejidos blandos, músculos, huesos, nervios y articulaciones.
                        </p>
                    </div>
                    <div class="col s12 m5 l4">
                        <center>
                ...
                <div class="row z-depth-2 section">
                    <center><h5>Fisioterapia Geriátrica</h5></center>
                    <div class=" col s12 m7 l8" style="padding-left: 30px;">                        
                        <p>
                ...
                <div class="row z-depth-2 section">
                    ...
                    <div class="col s12 m5 l4">
                        <center>
                            <img class="responsive-img" style="height: 250px;" src="<?php //echo asset('terapeutas/lizbeth_mendoza.jpeg')?>">
                        </center>
                    </div>
                </div>
